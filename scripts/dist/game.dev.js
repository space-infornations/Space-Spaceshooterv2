...
var bulletDamage = 0.99; // Bullet damage
...
function canShoot() {
  ...
  return currentTime - lastShotTime >= cooldownPeriod && battery >= batteryConsumption && currentTime - lastBatteryCooldownTime >= batteryCooldownPeriod && overheatLevel < maxOverheat;
}
