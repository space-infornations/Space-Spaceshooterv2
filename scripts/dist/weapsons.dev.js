...
var iceDamage = 1.4; // Updated ice weapon damage
...
var incrementalDamage = 0.8; // Reduced damage per bullet hit
...
var damageThreshold = 0.4; // Total damage threshold to apply additional effects
...
var missileDamage = 1.8; // High damage for missiles
...
function gameLoop() {
  ...
  updateParticles();
  drawParticles(ctx); //Enemy asteriod
}
